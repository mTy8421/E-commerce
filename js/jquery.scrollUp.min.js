...
!(function (a, b, c) {
  (a.fn.scrollUp = function (b) {
    ...
    (a.fn.scrollUp.init = function (d) {
      ...
      (e = f.scrollTrigger
        ? a(f.scrollTrigger)
        : a("<a/>", { id: f.scrollName, href: "#top" })),
        f.scrollTitle && e.attr("title", f.scrollTitle),
        e.appendTo("body"),
        f.scrollImg || f.scrollTrigger || e.html(f.scrollText),
        e.css({ display: "none", position: "fixed", zIndex: f.zIndex }),
        f.activeOverlay &&
          a("<div/>", { id: f.scrollName + "-active" })
            .css({
              position: "absolute",
      ...
      j =
        "top" === f.scrollFrom
          ? f.scrollDistance
          : a(c).height() - a(b).height() - f.scrollDistance;
      var k = !1;
      ...
      var l;
      f.scrollTarget
        ? "number" == typeof f.scrollTarget
          ? (l = f.scrollTarget)
          : "string" == typeof f.scrollTarget &&
            (l = Math.floor(a(f.scrollTarget).offset().top))
        : (l = 0),
        e.click(function (b) {
          b.preventDefault(),
            a("html, body").animate(
